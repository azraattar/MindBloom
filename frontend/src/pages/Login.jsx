...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // User is automatically created if they don't exist
      navigate("/games");
    } catch (error) {
            ...
            <div className="w-full md:w-3/5 p-8 md:p-16 flex flex-col justify-center">
              ...
              <form onSubmit={handleEmailLogin} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    className="text-sm text-[#22442E] font-bold hover:underline cursor-target"
                    disabled={loading}
                  >
                    Forgot password?
                  </button>
                ...
                <p className="text-center text-gray-600 mt-6 text-sm">
                  New user? Don't worry, we'll create an account for you automatically! 🌿
                </p>
              </form>
            </div>
